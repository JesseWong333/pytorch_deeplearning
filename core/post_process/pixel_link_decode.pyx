import cv2
import numpy as np
# from data.image_pixel_link_dataset import PixelLinkConfig
...
def get_neighbours(x, y):
    # import config
    neighbour_type = config['pixel_link']['pixel_neighbour_type']
